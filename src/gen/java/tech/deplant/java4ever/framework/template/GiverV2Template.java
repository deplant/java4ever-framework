...
public record GiverV2Template(ContractAbi abi, Tvc tvc) implements Template {
	...
	public DeployHandle<GiverV2Contract> prepareDeploy(int sdk, Credentials credentials) {
		Map<String, Object> initialDataFields = Map.of();
		Map<String, Object> params = Map.of();
		return new DeployHandle<GiverV2Contract>(GiverV2Contract.class,
		                                         sdk,
		                                         abi(),
		                                         tvc(),
		                                         EverSdk.getDefaultWorkchainId(sdk),
		                                         credentials,
		                                         initialDataFields,
		                                         params,
		                                         null);
