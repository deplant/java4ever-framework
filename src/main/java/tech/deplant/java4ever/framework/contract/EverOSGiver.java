...
public class EverOSGiver extends OwnedContract implements Giver {
	...
	public static Credentials KEYS = new StaticCredentials(
	...
	public EverOSGiver(Sdk sdk, Address address, Credentials owner, IAbi abi) {
	...
	public static IAbi ABI() throws JsonProcessingException {
		return CachedAbi.ofResource("/artifacts/giver/GiverV2.abi.json");
	}
