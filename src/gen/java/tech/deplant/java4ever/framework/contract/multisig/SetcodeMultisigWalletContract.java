...
public class SetcodeMultisigWalletContract extends MultisigContract {
  public SetcodeMultisigWalletContract(Sdk sdk, String address) throws JsonProcessingException {
    super(sdk,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SetcodeMultisigWalletContract(Sdk sdk, String address, ContractAbi abi) {
    super(sdk,address,abi,Credentials.NONE);
  }

  public SetcodeMultisigWalletContract(Sdk sdk, String address, Credentials credentials) throws
