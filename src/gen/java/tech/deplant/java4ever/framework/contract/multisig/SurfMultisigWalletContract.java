...
public class SurfMultisigWalletContract extends MultisigContract {
  public SurfMultisigWalletContract(Sdk sdk, String address) throws JsonProcessingException {
    super(sdk,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SurfMultisigWalletContract(Sdk sdk, String address, ContractAbi abi) {
    super(sdk,address,abi,Credentials.NONE);
  }

  public SurfMultisigWalletContract(Sdk sdk, String address, Credentials credentials) throws
