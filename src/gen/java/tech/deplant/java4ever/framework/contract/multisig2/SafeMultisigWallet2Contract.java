...
public class SafeMultisigWallet2Contract extends MultisigContract2 {
	public SafeMultisigWallet2Contract(int sdk, String address) throws JsonProcessingException {
		super(sdk, address, DEFAULT_ABI(), Credentials.NONE);
	}

	public SafeMultisigWallet2Contract(int sdk, String address, ContractAbi abi) {
		super(sdk, address, abi, Credentials.NONE);
	}

	public SafeMultisigWallet2Contract(int sdk, String address, Credentials credentials) throws
	...
	public FunctionHandle<ResultOfSubmitTransaction> submitTransaction(Address dest,
	                                                                   BigInteger value,
	                                                                   Boolean bounce,
	                                                                   Boolean allBalance,
	                                                                   TvmCell payload,
		...
		Map<String, Object> params = Map.of("dest", dest,
		                                    ...
		                                    "payload", payload,
		                                    "stateInit", stateInit);
		return new FunctionHandle<ResultOfSubmitTransaction>(ResultOfSubmitTransaction.class,
		                                                     sdk(),
		                                                     address(),
		                                                     abi(),
		                                                     credentials(),
	...
	public FunctionHandle<ResultOfIsConfirmed> isConfirmed(Long mask, Integer index) {
		Map<String, Object> params = Map.of("mask", mask,
		                                    "index", index);
		return new FunctionHandle<ResultOfIsConfirmed>(ResultOfIsConfirmed.class,
		                                               sdk(),
		                                               address(),
		                                               abi(),
		                                               credentials(),
	...
	public FunctionHandle<ResultOfGetParameters> getParameters() {
		...
		return new FunctionHandle<ResultOfGetParameters>(ResultOfGetParameters.class,
		                                                 sdk(),
		                                                 address(),
		                                                 abi(),
		                                                 credentials(),
	...
	public FunctionHandle<ResultOfGetTransaction> getTransaction(BigInteger transactionId) {
		Map<String, Object> params = Map.of("transactionId", transactionId);
		return new FunctionHandle<ResultOfGetTransaction>(ResultOfGetTransaction.class,
		                                                  sdk(),
		                                                  address(),
		                                                  abi(),
		                                                  credentials(),
	...
	public FunctionHandle<ResultOfGetTransactions> getTransactions() {
		Map<String, Object> params = Map.of();
		return new FunctionHandle<ResultOfGetTransactions>(ResultOfGetTransactions.class,
		                                                   sdk(),
		                                                   address(),
		                                                   abi(),
		                                                   credentials(),
	...
	public FunctionHandle<ResultOfGetCustodians> getCustodians() {
		Map<String, Object> params = Map.of();
		return new FunctionHandle<ResultOfGetCustodians>(ResultOfGetCustodians.class,
		                                                 sdk(),
		                                                 address(),
		                                                 abi(),
		                                                 credentials(),
