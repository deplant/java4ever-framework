...
public record TIP3TokenWallet(Sdk sdk, String address, ContractAbi abi,
  ...
  public TIP3TokenWallet(Sdk sdk, String address) throws JsonProcessingException {
  ...
  public TIP3TokenWallet(Sdk sdk, String address, Credentials credentials) throws
