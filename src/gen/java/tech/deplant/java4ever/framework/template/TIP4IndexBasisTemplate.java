...
import tech.deplant.java4ever.framework.contract.tip4.TIP4IndexBasisContract;
...
public record TIP4IndexBasisTemplate(ContractAbi abi, Tvc tvc) implements Template {
  ...
  public DeployHandle<TIP4IndexBasisContract> prepareDeploy(Sdk sdk, Credentials credentials,
      Address _collection) {
    Map<String, Object> initialDataFields = Map.of("_collection", _collection);
    Map<String, Object> params = Map.of();
    return new DeployHandle<TIP4IndexBasisContract>(TIP4IndexBasisContract.class, sdk, abi(), tvc(), sdk.clientConfig().abi().workchain(), credentials, initialDataFields, params, null);
  }
}
