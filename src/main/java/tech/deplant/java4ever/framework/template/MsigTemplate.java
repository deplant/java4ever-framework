...
public class MsigTemplate extends ContractTemplate {
	...
	public static final ContractTvc SAFE_MULTISIG_TVC = ContractTvc.ofResource(
			"artifacts/multisig/SafeMultisigWallet.tvc");
	public static final ContractTvc SETCODE_MULTISIG_TVC = ContractTvc.ofResource(
			"artifacts/multisig/SetcodeMultisigWallet.tvc");
	public static final ContractTvc SURF_MULTISIG_TVC = ContractTvc.ofResource(
			"artifacts/multisig/SurfMultisigWallet.tvc");
	...
	public Msig deploy3of5(Sdk sdk,
	                       ...
	                       String pubkey3,
	                       String pubkey4,
	                       String pubkey5) throws EverSdkException {
		var params = Map.<String, Object>of(
