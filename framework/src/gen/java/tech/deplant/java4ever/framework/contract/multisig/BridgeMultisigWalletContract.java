...
/**
 * Java wrapper class for usage of <strong>BridgeMultisigWalletContract</strong> contract for Everscale blockchain.
 */
public class BridgeMultisigWalletContract extends MultisigContract {
  public BridgeMultisigWalletContract(int contextId, String address) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public BridgeMultisigWalletContract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public BridgeMultisigWalletContract(int contextId, String address, Credentials credentials) throws
      JsonProcessingException {
