...
public class MultisigContractTests {
    ...
    public void use_giver_as_abstract_contract() throws JsonProcessingException, EverSdkException {
        ...
        var deployedContractCredentials = new Credentials("2ada2e65ab8eeab09490e3521415f45b6e42df9c760a639bcf53957550b25a16", "172af540e43a524763dd53b26a066d472a97c4de37d5498170564510608250c3");
        var contextId = Env.SDK_LOCAL;
        var giverContract = new AbstractContract(contextId, deployedContractAddress, deployedContractAbi, deployedContractCredentials);
        var functionCallPrepare = giverContract.functionCallBuilder().setFunctionName("getMessages").setFunctionInputs(Map.of()).setReturnClass(Map.class).build();
    ...
    public void address_from_template_equals_address_from_builder() throws JsonProcessingException, EverSdkException {
        ...
        var addressTemplate = new SafeMultisigWalletTemplate().prepareDeploy(Env.SDK_LOCAL, 0, keys, new BigInteger[]{keys.publicKeyBigInt()}, 1).toAddress();
    ...
    public void readmeSnippet01() throws JsonProcessingException, EverSdkException {
        ...
        var contract = new SafeMultisigWalletTemplate().prepareDeploy(contextId, 0, keys, new BigInteger[]{keys.publicKeyBigInt()}, 1).deployWithGiver(EverOSGiver.V2(contextId), EVER_ONE);
    ...
    public void getCustodian_get_custodians_test() throws EverSdkException, JsonProcessingException {
        ...
        CTX = EverSdk.builder().networkEndpoints("https://devnet.evercloud.dev/032a23e8f6254ca0b4ae4046819e7ac1/graphql").networkQueryTimeout(300000L).build();
        var myEverWallet = new SafeMultisigWalletContract(CTX, "0:b238570f9ebe536885b6060c7c9d74a20704e5efa844b17afcf814c7b9ddcfee", new Credentials("a08ba000d026068f90541f111e2c700a796222d8ab4bb4ae8b4e680f64f875da", "17011c9157f3cf9e3c75ce8778be6b1adc42cd7abc1aebc0d288d2c338d2d93b"));
    ...
    public void convertInputs_from_complex_structure() throws JsonProcessingException, EverSdkException {
        ...
        tuple1.put("index", new BigInteger("1"));
        tuple1.put("addr", Address.ZERO);
        var tuple2 = new HashMap<String, Object>();
        tuple2.put("index", new BigInteger("1"));
        tuple2.put("addr", Address.ZERO);
        var input = new HashMap<String, Object>();
        input.put("addresses", new HashMap[]{tuple1, tuple2});
        System.out.println(JsonContext.ABI_JSON_MAPPER().writeValueAsString(abi.convertFunctionInputs("sendAddresses", input)));
    }
