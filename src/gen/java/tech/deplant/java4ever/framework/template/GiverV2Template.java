...
public record GiverV2Template(ContractAbi abi, Tvc tvc) implements Template {
  ...
  public DeployCall<GiverV2> prepareDeploy(Sdk sdk, Credentials credentials) {
    Map<String, Object> initialDataFields = Map.of();
    Map<String, Object> params = Map.of();
    return new DeployCall<GiverV2>(GiverV2.class, sdk, abi(), tvc(), sdk.clientConfig().abi().workchain(), credentials, initialDataFields, params, null);
  }
}
