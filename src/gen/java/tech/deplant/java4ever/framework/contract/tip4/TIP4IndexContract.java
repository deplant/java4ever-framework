...
public class TIP4IndexContract extends AbstractContract {
  public TIP4IndexContract(Sdk sdk, String address) throws JsonProcessingException {
    super(sdk,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public TIP4IndexContract(Sdk sdk, String address, ContractAbi abi) {
    super(sdk,address,abi,Credentials.NONE);
  }

  public TIP4IndexContract(Sdk sdk, String address, Credentials credentials) throws
      JsonProcessingException {
    super(sdk,address,DEFAULT_ABI(),credentials);
  }

  @JsonCreator
  public TIP4IndexContract(Sdk sdk, String address, ContractAbi abi, Credentials credentials) {
