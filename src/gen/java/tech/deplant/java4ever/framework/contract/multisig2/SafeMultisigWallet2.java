...
/**
 * Java wrapper class for usage of <strong>SafeMultisigWallet2</strong> contract for Everscale blockchain.
 */
public record SafeMultisigWallet2(Sdk sdk, String address, ContractAbi abi,
    Credentials credentials) implements MultisigWallet2 {
  public SafeMultisigWallet2(Sdk sdk, String address) throws JsonProcessingException {
    this(sdk,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SafeMultisigWallet2(Sdk sdk, String address, ContractAbi abi) {
    this(sdk,address,abi,Credentials.NONE);
  }

  public SafeMultisigWallet2(Sdk sdk, String address, Credentials credentials) throws
