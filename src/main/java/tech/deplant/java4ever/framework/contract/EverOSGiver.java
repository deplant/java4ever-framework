...
public record EverOSGiver(IContract.Owned contract) implements Giver {
    ...
    public EverOSGiver(Sdk sdk) throws JsonProcessingException {
        this(new OwnedContract(new ActiveContract(sdk, ADDRESS, ArtifactABI.ofResource(ABI_FILE_NAME)), KEYS));
    }
