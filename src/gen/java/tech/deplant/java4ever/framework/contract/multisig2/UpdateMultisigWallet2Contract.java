...
public class UpdateMultisigWallet2Contract extends MultisigContract2 {
  public UpdateMultisigWallet2Contract(Sdk sdk, String address) throws JsonProcessingException {
    super(sdk,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public UpdateMultisigWallet2Contract(Sdk sdk, String address, ContractAbi abi) {
    super(sdk,address,abi,Credentials.NONE);
  }

  public UpdateMultisigWallet2Contract(Sdk sdk, String address, Credentials credentials) throws
