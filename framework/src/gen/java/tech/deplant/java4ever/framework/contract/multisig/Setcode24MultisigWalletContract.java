...
/**
 * Java wrapper class for usage of <strong>Setcode24MultisigWalletContract</strong> contract for Everscale blockchain.
 */
public class Setcode24MultisigWalletContract extends MultisigContract {
  public Setcode24MultisigWalletContract(int contextId, String address) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public Setcode24MultisigWalletContract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public Setcode24MultisigWalletContract(int contextId, String address, Credentials credentials)
