...
public record ContractTvc(byte[] bytes) {
    ...
    public Map<String, Object> decodeInitialData(Sdk sdk, ContractAbi abi) {
        return sdkDecodeInitialData(sdk, abi).initialData();
    }

    public String decodeInitialPubkey(Sdk sdk, ContractAbi abi) {
    ...
    public ContractTvc withUpdatedInitialData(Sdk sdk, ContractAbi abi, Map<String, Object> initialData, String publicKey) {
    ...
    private Abi.ResultOfDecodeInitialData sdkDecodeInitialData(Sdk sdk, ContractAbi abi) {
