...
/**
 * Java wrapper class for usage of <strong>SafeMultisigSolc064WalletContract</strong> contract for Everscale blockchain.
 */
public class SafeMultisigSolc064WalletContract extends MultisigContract {
  public SafeMultisigSolc064WalletContract(int contextId, String address) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SafeMultisigSolc064WalletContract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public SafeMultisigSolc064WalletContract(int contextId, String address, Credentials credentials)
  ...
  public FunctionHandle<ResultOfGetTransactionIds> getTransactionIds() {
    throw new UnsupportedOperationException("No such method in this Multisig variant!");
  }
